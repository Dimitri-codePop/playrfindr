...
export default function Cgu({
  ...
  return (
<main className="cgu">
<div className="cgu-subitems">
  <h1 className="cgu-title-primary">Conditions générales d'utilisation du site Playrfindr</h1>
  <div>
    <div className="cgu-title">
      <h2> Article 1 : Objet</h2>
    </div>
    <p>Les présentes CGU ou Conditions Générales d'Utilisation encadrent juridiquement l'utilisation des services du site Playrfindr.
    Constituant le contrat entre la société Radis & Co., l'Utilisateur, l'accès au site doit être précédé de l'acceptation de ces CGU. L'accès à cette plateforme signifie l'acceptation des présentes CGU.</p>
  </div>
  <div>
    <div className="cgu-title">
      <h2>Article 2 : Mentions légales</h2>
    </div>
    <p>L'édition du site Playrfindr est assurée par la société Playrfindr. inscrite au RCS sous le numéro 451 432 289, dont le siège social est localisé au 38 Rue Docteur Joubert, 59800, Lille, France Métropolitaine. L'hébergeur du site Playrfindr.fr est la société OVH, au 38 Rue du Chateaux, 59100 Roubaix, France.</p>
  </div>
  <div>
    <div className="cgu-title">
      <h2>Article 3 : Accès au site</h2>
    </div>
    <p>Le site est accessible gratuitement depuis n'importe où par tout utilisateur disposant d'un accès à Internet. Tous les frais nécessaires pour l'accès aux services (matériel informatique, connexion Internet…) sont à la charge de l'utilisateur. L'accès aux services dédiés aux membres s'effectue à l'aide d'un identifiant et d'un mot de passe. Pour des raisons de maintenance ou autres, l'accès au site peut être interrompu ou suspendu par l'éditeur sans préavis ni justification.</p>
  </div>
  <div id="collecte-donnees">
    <div className="cgu-title">
  ...
  <div>
    ...
    Les informations diffusées sur le site Playrfindr sont présentées à titre purement informatif et sont sans valeur contractuelle. En dépit des mises à jour régulières, la responsabilité du site ne peut être engagée en cas de modification des dispositions administratives et juridiques apparaissant après la publication. Il en est de même pour l'utilisation et l'interprétation des informations communiquées sur la plateforme.</p>
    <p>Le site décline toute responsabilité concernant les éventuels virus pouvant infecter le matériel informatique de l'Utilisateur après l'utilisation ou l'accès à ce site.
    Le site ne peut être tenu pour responsable en cas de force majeure ou du fait imprévisible et insurmontable d'un tiers. La garantie totale de la sécurité et la confidentialité des données n'est pas assurée par le site. Cependant, le site s'engage à mettre en œuvre toutes les méthodes requises pour le faire au mieux.</p>
  </div>
  <div>
    <div className="cgu-title">
  ...
  <div>
    ...
    <p>À chaque utilisation, l'éditeur s'engage à mentionner le nom du membre à proximité de la publication. L'Utilisateur est tenu responsable de tout contenu qu'il met en ligne. L'Utilisateur s'engage à ne pas publier de contenus susceptibles de porter atteinte aux intérêts de tierces personnes. Toutes procédures engagées en justice par un tiers lésé à l'encontre du site devront être prises en charge par l'Utilisateur.</p>
